        ...
        <div style="max-width: 600px; margin: 0 auto; background-color: white; padding: 0;">
          ...
          <div style="padding: 40px 30px;">
            ...
            <div style="background: #fef2f2; border-left: 4px solid #DC2626; padding: 20px; margin: 25px 0; border-radius: 4px;">
              <h4 style="margin: 0 0 10px 0; color: #991b1b; font-size: 16px;">🚨 Travel Requirements:</h4>
              <ul style="margin: 0; padding-left: 20px; color: #991b1b; font-size: 14px; line-height: 1.6;">
                <li>Your passport must be valid for at least 60 days from entry date</li>
                <li>Print your e-visa and carry it with you during travel</li>
                <li>Present your e-visa with your passport when entering Turkey</li>
                <li>Keep a digital copy on your phone as backup</li>
              </ul>
            </div>
            ...
            <div style="background-color: #f0f9ff; padding: 20px; border-radius: 6px; margin: 25px 0;">
              ...
              <p style="margin: 0; color: #1e40af; font-size: 14px; line-height: 1.6;">
                If you have any questions about your e-visa or need assistance:<br>
                📧 Email: info@getvisa.tr<br>
