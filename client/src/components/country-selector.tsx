...
export function CountrySelector({
  ...
  const renderEligibilityStatus = () => {
    ...
    if (selectedCountry.scenario === 1 || selectedCountry.scenario === 2) {
      return (
          ...
          <AlertDescription className="text-blue-800">
            <div>
              <strong className="text-blue-900">
                {t("country.selector.visa.free.title")}
              </strong>
              <br />
    ...
    if (
      (!selectedCountry.isEligible && selectedCountry.scenario !== 3) ||
      selectedCountry.scenario === 4
    ) {
      return (
          ...
          <AlertDescription className="text-red-800">
            <div className="space-y-3">
              <div>
                ...
                <p>
                  An e‑Visa cannot be issued for citizens of the country you
                  selected. You must apply for a visa at your nearest Turkish
                  mission or consulate. However, according to Turkish
                  immigration law, travel insurance is mandatory for all
                  visitors to Turkey regardless of visa type.
                </p>
              </div>
              <div className="mt-4">
                <button
  ...
  return (
    <div className="space-y-6">
            ...
            <SelectContent>
              {isLoading ? (
                ...
                <SelectItem value="no-data" disabled>
                  No countries available (Query returned empty)
                </SelectItem>
              ) : (
                [...countries]
      ...
      {showEligibilityStatus && (
        <div className="mt-6">{renderEligibilityStatus()}</div>
      )}
    </div>
  );
}
