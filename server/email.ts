...
export function generateVisaApprovalEmail(
  ...
  if (language === 'tr') {
    return {
      subject: "Türkiye E-Vize Başvurunuz Onaylandı",
      html: `
        <!DOCTYPE html>
        <html>
        <head>
          ...
          <div style="max-width: 600px; margin: 0 auto; background-color: white; padding: 0;">
            ...
            <div style="padding: 40px 30px;">
              ...
              <p style="color: #4a4a4a; line-height: 1.6; margin-bottom: 20px;">
                Türkiye Cumhuriyeti E-Vize başvurunuz başarıyla onaylanmıştır. 
                Başvuru detaylarınız aşağıda yer almaktadır.
              </p>
              ...
              <div style="background-color: #f8f9fa; padding: 20px; border-radius: 8px; margin: 20px 0;">
                ...
                <table style="width: 100%; border-collapse: collapse;">
                  ...
                  <tr>
                    ...
                    <td style="padding: 8px 0; color: #16a34a; font-weight: bold;">✓ ONAYLANDI</td>
                  </tr>
                </table>
              </div>
              ...
              <div style="background-color: #fef3c7; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0;">
                <p style="margin: 0; color: #92400e; font-size: 14px;">
                  <strong>Önemli Not:</strong> E-vizenizi web sitemizden indirip yazdırmanız ve seyahat sırasında yanınızda bulundurmanız gerekmektedir.
                </p>
              </div>
              ...
              <div style="background-color: #f8f9fa; padding: 20px; border-radius: 8px; margin: 20px 0;">
                ...
                <table style="width: 100%; border-collapse: collapse;">
                  ...
                  <tr>
                    ...
                    <td style="padding: 8px 0; color: #16a34a; font-weight: bold;">✓ APPROVED</td>
                  </tr>
                </table>
              </div>
        ...
        <body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f5f5f5;">
          <div style="max-width: 600px; margin: 0 auto; background-color: white; padding: 0;">
            ...
            <div style="padding: 40px 30px;">
              ...
              <p style="color: #4a4a4a; line-height: 1.6; margin-bottom: 20px;">
                Seyahat sigortası başvurunuz başarıyla onaylanmıştır. 
